...
| 10 | [因子引擎设计文档](10-factor-engine.md) | 15+因子实现、FactorRegistry、因子合成引擎、加权/排名合成 |
| 11 | [因子算法参考](11-factor-algorithms.md) | RSI/MACD/布林带/KDJ/动量/情绪/估值/轮动因子算法详解 |
