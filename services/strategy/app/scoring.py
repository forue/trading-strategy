...
# key 为板块名或板块类别名，_get_etf_info 会先用 sector_name 匹配
SECTOR_ETF_CANDIDATES = {
    # === 科技 ===
    "软件开发": [
        {"code": "159035", "name": "软件ETF天弘"}, {"code": "562930", "name": "软件ETF易方达"},
        {"code": "560360", "name": "软件ETF万家"}, {"code": "515230", "name": "软件ETF国泰"},
    ],
    "IT服务": [
        {"code": "512720", "name": "计算机ETF国泰"}, {"code": "159998", "name": "计算机ETF天弘"},
    ],
    "计算机设备": [
        {"code": "512720", "name": "计算机ETF国泰"}, {"code": "159586", "name": "计算机ETF南方"},
    ],
    "半导体": [
        {"code": "159995", "name": "芯片ETF华夏"}, {"code": "512480", "name": "半导体ETF国联安"},
        {"code": "159813", "name": "芯片ETF鹏华"},
    ],
    "电子": [
        {"code": "159997", "name": "电子ETF天弘"}, {"code": "159958", "name": "电子ETF"},
    ],
    "消费电子": [
        {"code": "159732", "name": "消费电子ETF华夏"}, {"code": "562950", "name": "消费电子ETF易方达"},
        {"code": "561100", "name": "消费电子ETF富国"},
    ],
    "元件": [
        {"code": "159997", "name": "电子ETF天弘"}, {"code": "515210", "name": "电子元件ETF"},
    ],
    "光学光电子": [
    ...
    "电子化学品": [
        {"code": "159870", "name": "化工ETF"}, {"code": "159997", "name": "电子ETF天弘"},
    ],
    "通信设备": [
        {"code": "515880", "name": "通信ETF国泰"}, {"code": "159619", "name": "5G ETF"},
    ],
    "通信服务": [
    ...
    # === 新能源 ===
    "光伏设备": [
        {"code": "515790", "name": "光伏ETF华泰柏瑞"}, {"code": "515370", "name": "光伏ETF华夏"},
        {"code": "159857", "name": "光伏ETF天弘"}, {"code": "159863", "name": "光伏ETF鹏华"},
    ],
    "风电设备": [
        {"code": "159819", "name": "碳中和ETF"}, {"code": "516160", "name": "新能源ETF"},
    ],
    "电池": [
        {"code": "159755", "name": "电池ETF"}, {"code": "159840", "name": "锂电池ETF"},
        {"code": "561910", "name": "动力电池ETF"},
    ],
    "其他电源设备": [
        {"code": "159755", "name": "电池ETF"}, {"code": "516160", "name": "新能源ETF"},
    ],
    "新能源": [
        {"code": "516160", "name": "新能源ETF"}, {"code": "159875", "name": "新能源车ETF"},
    ],
    "电网设备": [
        {"code": "159611", "name": "公用事业ETF"},
    ],
    "电力": [
        {"code": "159611", "name": "公用事业ETF"}, {"code": "159662", "name": "交运ETF"},
    ],
    "燃气": [
        {"code": "159611", "name": "公用事业ETF"},
    ],
    ...
    # === 消费 ===
    "白酒": [
        {"code": "512690", "name": "酒ETF鹏华"}, {"code": "515710", "name": "食品饮料ETF华宝"},
    ...
    "食品加工制造": [
        {"code": "159843", "name": "食品饮料ETF招商"}, {"code": "515710", "name": "食品饮料ETF华宝"},
    ],
    "家用电器": [
        {"code": "159746", "name": "家电ETF"},
    ],
    "白色家电": [
        {"code": "159746", "name": "家电ETF"},
    ],
    ...
    "纺织制造": [
        {"code": "159573", "name": "纺织服装ETF"},
    ],
    "服装家纺": [
        {"code": "159573", "name": "纺织服装ETF"},
    ],
    "家居用品": [
        {"code": "159828", "name": "消费ETF"},
    ],
    "美容护理": [
        {"code": "159828", "name": "消费ETF"},
    ],
    "零售": [
        {"code": "159828", "name": "消费ETF"}, {"code": "510630", "name": "消费ETF华夏"},
    ],
    "旅游及酒店": [
    ...
    # === 医药 ===
    "医药": [
        {"code": "512010", "name": "医药ETF"}, {"code": "159929", "name": "医药ETF恒瑞"},
    ],
    "化学制药": [
        {"code": "512010", "name": "医药ETF"},
    ],
    "中药": [
        {"code": "512010", "name": "医药ETF"}, {"code": "159883", "name": "中药ETF"},
    ],
    "生物制品": [
        {"code": "512010", "name": "医药ETF"},
    ],
    "医疗器械": [
        {"code": "512010", "name": "医药ETF"}, {"code": "512170", "name": "医疗ETF华宝"},
    ],
    "医疗服务": [
        {"code": "512010", "name": "医药ETF"}, {"code": "512170", "name": "医疗ETF华宝"},
    ],
    ...
    # === 金融 ===
    "银行": [
        {"code": "512800", "name": "银行ETF华宝"}, {"code": "515020", "name": "银行ETF华夏"},
    ],
    "证券": [
        {"code": "512880", "name": "证券ETF国泰"}, {"code": "512070", "name": "证券保险ETF易方达"},
    ...
    # === 周期/资源 ===
    "钢铁": [
        {"code": "562300", "name": "钢铁ETF"},
    ],
    "有色金属": [
        {"code": "512400", "name": "有色金属ETF"},
    ],
    "贵金属": [
        {"code": "512400", "name": "有色金属ETF"}, {"code": "159930", "name": "黄金ETF"},
    ],
    "小金属": [
        {"code": "512400", "name": "有色金属ETF"},
    ],
    ...
    # === 制造/军工 ===
    "军工": [
        {"code": "512810", "name": "军工ETF华宝"}, {"code": "512660", "name": "军工ETF国泰"},
    ...
    "汽车": [
        {"code": "516110", "name": "汽车ETF国泰"}, {"code": "159768", "name": "新能源车ETF华夏"},
    ],
    "汽车整车": [
    ...
    "机械": [
        {"code": "159886", "name": "机械ETF富国"}, {"code": "516960", "name": "机械ETF国泰"},
    ],
    "通用设备": [
    ...
    "工程机械": [
        {"code": "515970", "name": "工程机械ETF华夏"}, {"code": "560280", "name": "工程机械ETF广发"},
    ],
    "自动化设备": [
        {"code": "159886", "name": "机械ETF富国"}, {"code": "512720", "name": "计算机ETF国泰"},
    ],
    "轨交设备": [
        {"code": "159886", "name": "机械ETF富国"},
    ],
    ...
    # === 建筑/地产 ===
    "建筑材料": [
        {"code": "159745", "name": "建材ETF"},
    ],
    "建筑装饰": [
        {"code": "159740", "name": "基建ETF"},
    ],
    ...
    # === 传媒/娱乐 ===
    "传媒": [
        {"code": "512980", "name": "传媒ETF广发"}, {"code": "516190", "name": "传媒ETF华夏"},
    ...
    "游戏": [
        {"code": "516770", "name": "游戏ETF华泰柏瑞"}, {"code": "516010", "name": "游戏ETF国泰"},
    ...
    # === 其他 ===
    "综合": [
        {"code": "511020", "name": "综合ETF"},
    ],
    "造纸": [
        {"code": "159608", "name": "轻工ETF"},
    ],
    "包装印刷": [
        {"code": "159608", "name": "轻工ETF"},
    ],
